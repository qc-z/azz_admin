...
exports.pay = function (openid, money) {
  ...
  var wishing = '感谢您参与颜值分享活动，恭喜你获得红包'
...
function getSign(obj) {
    ...
    stringAArr[8] = 'wishing=感谢您参与颜值分享活动，恭喜你获得红包'
    stringAArr[10] = 'act_name=颜值分享拿红包活动'
...
exports.taianPay = function (openid, money) {
  ...
  var moneyNum = 100 * money // 单位是分
  // var openid = 'oS_4zxJFOK_CyO-AEiua2L3uVdxU'
  var wishing = '感谢您参与双11脱单福利，恭喜你获得红包'
  // var wishing = 'goodluck'
...
function tananSign(obj) {
    ...
    stringAArr[8] = 'wishing=感谢您参与双11脱单福利，恭喜你获得红包'
    stringAArr[10] = 'act_name=双11脱单福利'
    ...
    var stringSignTemp = stringA + '&key=' + 'taianhanmeizhengxing678988888888'
    // console.log('第二步：'+stringSignTemp)
